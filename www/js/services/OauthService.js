...
// max count = 25; start increments at 25.
	...
	function login() {
		...
		ref.addEventListener('loadstart', function(e) {
			...
			var tokenUrl = url.split('token=')[1];

			if(tokenUrl !== undefined) {
				console.log("found token");
				ref.close();
				tokenUrl = tokenUrl.split('&')[0];
				$http.defaults.headers.common.Authorization = 'Bearer ' + tokenUrl;
				getLeagueData();
			}
			...
			if(code !== undefined) {
				...
				$http.defaults.headers.common.Authorization = 'Basic ZGoweUptazlVbFJoZUhrMVUzWkhXSE42Sm1ROVdWZHJPVlZxYURWU1JFMHlUVEpOYldOSGJ6bE5RUzB0Sm5NOVkyOXVjM1Z0WlhKelpXTnlaWFFtZUQxaFlnLS06OTkzOWEzOWI5MTQwODFjZjU1OTA0ZmEyYzY4Y2VjMDgyNzdlNzlhNw==';
